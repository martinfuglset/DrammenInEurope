    ...
    <div className="min-h-screen bg-paper relative overflow-x-hidden selection:bg-royal selection:text-white pb-32">
      <div className="max-w-4xl mx-auto px-6 py-12 relative z-10">
        ...
        <div className="bg-white/50 backdrop-blur-sm border border-royal/10 p-8">
            <div className="prose prose-royal">
                <h3 className="text-xl font-display uppercase mb-4">Generelle retningslinjer</h3>
                <ul className="space-y-4 font-sans">
                    <li>Møt opp presis til avtalte tider.</li>
                    <li>Vis hensyn til andre reisende og lokalbefolkningen.</li>
                    <li>Hold orden på rommet og i bussen.</li>
                    <li>Gi beskjed til reiseleder hvis du forlater gruppen.</li>
                </ul>
            </div>
        </div>
      </div>
